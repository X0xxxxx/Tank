...
public class TrackSimulator : MonoBehaviour {
    ...
    //自动巡航动画曲线
    [System.Serializable]
    public class AutoCruiseAnimationCurves
    {
        public AnimationCurve moveForwardByFristGearMotorAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 23.0f, 0.0f);
        public AnimationCurve moveForwardByFristGearBrakeAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 23.0f, 12000.0f);
        public AnimationCurve moveForwardBySecondGearMotorAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 45.0f, 0.0f);
        public AnimationCurve moveForwardBySecondGearBrakeAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 45.0f, 12000.0f);
        public AnimationCurve moveForwardByThirdGearMotorAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 72.42f, 0.0f);
        public AnimationCurve moveForwardByThirdGearBrakeAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 72.42f, 12000.0f);
        public AnimationCurve backUpByFristGearMotorAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 230f, 0.0f);
        public AnimationCurve backUpByFristGearBrakeAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 23.0f, 12000.0f);
        public AnimationCurve backUpBySecondGearMotorAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 45.0f, 0.0f);
        public AnimationCurve backUpBySecondGearBrakeAnimationCurve = AnimationCurve.Linear(0.0f, 10000.0f, 45.0f, 12000.0f);
    }
    public AutoCruiseAnimationCurves autoCruiseAnimationCurves;
